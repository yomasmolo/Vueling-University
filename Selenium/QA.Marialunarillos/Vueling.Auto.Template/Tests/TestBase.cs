...
namespace Marialunarillos.Auto.Tests
{
    ...
    {
        #region Definitions
        protected MarialunarillosHomePage marialunarillosHomePage;
        protected ImpresionesComestiblesPage impresionesComestiblesPage;
        protected ProductosPage productosPage;
        protected Page page;
